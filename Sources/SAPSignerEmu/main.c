...
int main(void) {
    ...
    if ((ret = emulator_FairPlaySAPExchange(&emu, FairPlaySAPExchangeVersionNotPrimed, &hw_info, ctx, sign_sap_setup_cert_data, sign_sap_setup_cert_size, &sign_sap_setup_buffer_odata, &sign_sap_setup_buffer_osize, &err))) {
